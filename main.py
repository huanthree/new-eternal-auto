...
def add_server_time(server_url="https://gpanel.eternalzero.cloud/server/e9399799"):
    """
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            if not remember_web_cookie:
                ...
                # 定义选择器
                email_selector = 'input[name="username"]' # 根据网页实际情况，登录字段name为'username'
            ...
            # --- 核心操作：查找并点击 "ADD 6H" 按钮 ---
            add_button_selector = 'button:has-text("ADD 6H")'
            print(f"正在查找并等待 'ADD 6H' 按钮...")
            ...
            try:
                ...
                print(f"错误: 在30秒内未找到或 'ADD 6H' 按钮不可见/不可点击。")
